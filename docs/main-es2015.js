...
let NavbarComponent = class NavbarComponent {
    ...
    searchAdvanced(form) {
        ...
        let url = `https://newsapi.org/v2/${form.form.value.filter}?apiKey=d271b1bee3d941fa83b6e9df36bf1265${country}&category=${form.form.value.options}&shortBy=${form.form.value.sortBy}`;
...
let DataService = class DataService {
    ...
    googleSearch(searchTerm) {
        const win = window.open(`https://www.google.com/search?q=${searchTerm}`, '_blank');
        win.focus();
    }
    ;
};
...
let HomeComponent = class HomeComponent {
    constructor(_data, _rouetr) {
        this._data = _data;
        this._rouetr = _rouetr;
        this.subscribeRequest = this._data.subjectRequest.subscribe((data) => {
...
let NewComponent = class NewComponent {
    constructor(_data, _path, _router) {
        this._data = _data;
        this._path = _path;
        this._router = _router;
